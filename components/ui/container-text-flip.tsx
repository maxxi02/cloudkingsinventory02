...
export function ContainerTextFlip({
  ...
  const updateWidthForWord = () => {
    if (textRef.current) {
      ...
      // @ts-expect-error: textRef.current may be null or undefined during initial render
  ...
  return (
    <motion.div
      ...
      className={cn(
        'relative inline-block rounded-lg pb-1 mt-2 text-center text-4xl font-bold text-black md:text-7xl dark:text-white',
