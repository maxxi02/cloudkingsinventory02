  ...
  const handleDelete = useCallback(
    (id: string) => {
      mutate(id, {
        onSuccess: () => {
          refetch();
          toast.success('Session successfully deleted.', { duration: 3000 });
        },
        onError: (error) => {
          toast.error(`Unable to delete session: ${error.message}`, {
            duration: 3000,
          });
        },
      });
    ...
    <div className="via-root to-root rounded-xl bg-gradient-to-r p-0.5">
      <div className="rounded-[10px] p-6">
        ...
        <p className="mb-6 max-w-xl text-sm text-[#0007149f] dark:text-gray-100 font-normal">
          ...
          CloudKings Inventory These are the sessions where your account is
          ...
          <div className="rounded-t-xl max-w-xl">
            <div>
              ...
              <p className="mb-6 text-sm text-[#0007149f] dark:text-gray-100">
                You&#39;re logged into this CloudKings Inventory account on this
